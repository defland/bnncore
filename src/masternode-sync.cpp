...
std::string CMasternodeSync::GetAssetName()
{
    switch(nRequestedMasternodeAssets)
    {
        ...
        case(MASTERNODE_SYNC_WBNCING):      return "MASTERNODE_SYNC_WBNCING";
...
void CMasternodeSync::SwitchToNextAsset(CConnman& connman)
{
    switch(nRequestedMasternodeAssets)
    {
        ...
        case(MASTERNODE_SYNC_INITIAL):
            ...
            nRequestedMasternodeAssets = MASTERNODE_SYNC_WBNCING;
            LogPrintf("CMasternodeSync::SwitchToNextAsset -- Starting %s\n", GetAssetName());
            break;
        case(MASTERNODE_SYNC_WBNCING):
            ClearFulfilledRequests(connman);
...
std::string CMasternodeSync::GetSyncStatus()
{
    switch (masternodeSync.nRequestedMasternodeAssets) {
        ...
        case MASTERNODE_SYNC_WBNCING:       return _("Synchronization pending...");
...
void CMasternodeSync::ProcessTick(CConnman& connman)
{
    ...
    BOOST_FOREACH(CNode* pnode, vNodesCopy)
    {
        ...
        // NORMAL NETWORK MODE - TESTNET/MAINNET
        {
            ...
            if(nRequestedMasternodeAssets == MASTERNODE_SYNC_WBNCING) {
                if(GetTime() - nTimeLastBumped > MASTERNODE_SYNC_TIMEOUT_SECONDS) {
                    ...
                    //     MASTERNODE_SYNC_INITIAL to MASTERNODE_SYNC_WBNCING and bumped time);
