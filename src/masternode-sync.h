...
static const int MASTERNODE_SYNC_WBNCING         = 1; // waiting after initial to see if we can get more headers/blocks
...
public:
    ...
    bool IsBlockchainSynced() { return nRequestedMasternodeAssets > MASTERNODE_SYNC_WBNCING; }
