...
#define BOOST_TEST_MODULE Bluenode Test Suite

#include "test_bluenode.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bluenode_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
