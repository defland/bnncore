...
static const int MIN_PRIVATESEND_PEER_PROTO_VERSION = 68668;
static const int STRICT_PRIVATESEND_PEER_PROTO_VERSION = 68668;
...
public:
    ...
    /// Get the denominations for a specific amount of bluenode.
