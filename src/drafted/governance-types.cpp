...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BluenodeNetwork") type = BluenodeNetwork;
    if(strType == "BluenodeNetworkVariable") type = BluenodeNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BluenodeNetwork) s = "BluenodeNetwork";
    if(type == BluenodeNetworkVariable) s = "BluenodeNetworkVariable";
