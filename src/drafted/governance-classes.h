 ...
 *
 *   // network
 *   CBluenodeNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.bluenodecoin.com/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBluenodeNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CBluenodeNetwork(UniValue objIn)
    {
...
// // can be under: BluenodeNetwork
// //   -- signature requirements : Key1(User)
// class CBluenodeNetworkVariable : public CGovernanceObject
// {
// private:
