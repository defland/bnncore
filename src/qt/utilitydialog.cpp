    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bluenode Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Bluenode Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bluenode-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Bluenode in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BNN, 0.1 BNN, 1 BNN and 10 BNN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://bluenodecoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://bluenodecoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bluenode Core is shutting down...") + "<br /><br />" +
