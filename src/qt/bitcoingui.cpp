    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Bluenode Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bluenode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bluenode: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Bluenode Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bluenode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bluenode Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bluenode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bluenode addresses"));
    ...
    openAction->setStatusTip(tr("Open a bluenode: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bluenode Core help message to get a list with possible Bluenode Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Bluenode Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bluenode network", "", count));
    } else {
...
{
    QString strTitle = tr("Bluenode Core"); // default title
