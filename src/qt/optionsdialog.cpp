    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BNN-light"), QVariant("light"));
    ui->theme->addItem(QString("BNN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BNN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BNN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BNN-traditional"), QVariant("trad"));
