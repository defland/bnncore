...
This mechanism has been integrated into Bitcore-Node-Bluenode which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bluenodecore/insight-api-bluenode#web-socket-api](https://github.com/bluenodecore/insight-api-bluenode#web-socket-api)
* API: [https://github.com/bluenodecore/insight-api-bluenode#instantsend-transactions](https://github.com/bluenodecore/insight-api-bluenode#instantsend-transactions)
...
By default, the Bluenode Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bluenode Core daemon:
