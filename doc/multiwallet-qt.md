...
Only requiring some minor changes is bluenode.cpp.
...
Changes to bluenode.cpp
----------------------
bluenode.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
