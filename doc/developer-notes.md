...
Bluenode Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Bluenode Core, where everyone uses
...
pay attention to for reviewers of Bluenode Core code.

General Bluenode Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Bluenode Core uses tinyformat, which is type safe. Leave them out to avoid confusion
